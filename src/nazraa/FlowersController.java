...
public class FlowersController implements Initializable {
    ...
    @FXML
    protected void DisplayLotus(MouseEvent e)throws IOException{
    ...
    @FXML
    protected void DisplayLavender(MouseEvent e)throws IOException{
    ...
    @FXML
    protected void DisplayPetunia(MouseEvent e)throws IOException{
