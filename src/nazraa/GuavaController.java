 ...
 * @author Maram
 */
public class GuavaController implements Initializable {
    ...
    protected void BackScene(MouseEvent e)throws IOException{
        Parent Frits = FXMLLoader.load(getClass().getResource("Fruits.fxml"));
        Scene FritsScene = new Scene(Frits);
        Stage stage = (Stage)((Node)e.getSource()).getScene().getWindow();
        stage.setScene(FritsScene);
