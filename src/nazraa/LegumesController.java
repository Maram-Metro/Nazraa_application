...
public class LegumesController implements Initializable {
    ...
    @FXML
    protected void DisplayAlmonds(MouseEvent e)throws IOException{
    ...
    @FXML
    protected void DisplayPine(MouseEvent e)throws IOException{
    ...
    @FXML
    protected void DisplayOak(MouseEvent e)throws IOException{
